...
/// <summary>
/// Pure deterministic procedural-layout generator. Inputs: <see cref="ProceduralMapConfig"/>,
/// chunk pool, seed. Output: <see cref="ChunkLayout"/>. No DB / DI / scope dependencies — safe
/// for use from preview tooling (Api admin endpoints) and production world bootstrap alike.
/// Production callers (<c>ProceduralChunkLayoutSource</c>) load config + pool from DB and pass
/// them in.
/// </summary>
