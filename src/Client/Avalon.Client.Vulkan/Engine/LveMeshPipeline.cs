...
public class LveMeshPipeline : IDisposable
{
    ...
    public LveMeshPipeline(Vk vk, LveDevice device, string taskPath, string meshPath, string fragPath,
        PipelineConfigInfo configInfo, string renderSystemName = "unknown")
    {
        this.vk = vk;
        this.device = device;
