...
public class CGroupInviteResultPacket : Packet
{
    ...
    public static NetworkPacket Create(ulong accountId, ulong characterId, ulong inviterAccountId, ulong inviterCharacterId, bool accepted, EncryptFunc encryptFunc)
    {
