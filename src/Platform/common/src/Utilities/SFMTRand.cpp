#include <Common/Utilities/SFMTRand.h>
...
SFMTRand::SFMTRand()
{
    ...
    {
        sfmt_init_gen_rand(&_state, U32(GetEpochTime().count()));
    }
}

U32 SFMTRand::RandomUInt32()                            // Output random bits
{
