...
using SHA1 = Avalon::Crypto::SHA1;
using SRP6 = Avalon::Crypto::SRP6;

/*static*/ std::array<U8, 1> const SRP6::g = { 7 };
/*static*/ std::array<U8, 32> const SRP6::N = HexStrToByteArray<32>("894B645E89E1535BBDAD5B8B290650530801B18EBFBF5E8FAB3C82872A3E9BB7", true);
