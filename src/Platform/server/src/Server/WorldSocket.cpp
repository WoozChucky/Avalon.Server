...
{
    Avalon::Crypto::GetRandomBytes(_authSeed);
...
void WorldSocket::HandleSendAuthSession()
{
    ...
    packet.append(Avalon::Crypto::GetRandomBytes<32>());               // new encryption seeds
...
{
    U32 BattlegroupID = 0;
    U32 LoginServerType = 0;
    U32 RealmID = 0;
    U32 Build = 0;
    std::array<U8, 4> LocalChallenge = {};
    U32 LoginServerID = 0;
    U32 RegionID = 0;
    U64 DosResponse = 0;
    Avalon::Crypto::SHA1::Digest Digest = {};
    std::string Account;
...
WorldSocket::ReadDataHandlerResult WorldSocket::ReadDataHandler()
{
    ...
    if (!_worldSession)
    {
        LOG_ERROR("network.opcode", "ProcessIncoming: Client not authed opcode = {}", U32(opcode));
...
void WorldSocket::SendAuthResponseError(U8 code)
{
