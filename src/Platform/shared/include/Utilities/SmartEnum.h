...
public:
    template <typename Enum>
    static size_t Count() { return Avalon::Impl::EnumUtilsImpl::EnumUtils<Enum>::Count(); }
    template <typename Enum>
    static EnumText ToString(Enum value) { return Avalon::Impl::EnumUtilsImpl::EnumUtils<Enum>::ToString(value); }
    template <typename Enum>
    static Enum FromIndex(size_t index) { return Avalon::Impl::EnumUtilsImpl::EnumUtils<Enum>::FromIndex(index); }
    template <typename Enum>
    static U32 ToIndex(Enum value) { return Avalon::Impl::EnumUtilsImpl::EnumUtils<Enum>::ToIndex(value);}
    ...
    static bool IsValid(Enum value)
    {
        try
        {
            Avalon::Impl::EnumUtilsImpl::EnumUtils<Enum>::ToIndex(value);
            return true;
        }
        catch (...)
        {
    ...
    template <typename Enum>
    static Avalon::IteratorPair<Iterator<Enum>> Iterate() { return { Begin<Enum>(), End<Enum>() }; }
